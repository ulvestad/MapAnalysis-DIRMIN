/*
*
*   Filename: userInterface/js/latLng_UTM.js
*   @Author: Chuck Taylor
*   Source: http://home.hiwaay.net/~taylorc/toolbox/geography/geoutm.html
*
*   Description: Various functions used to convert between UTM coordinate system
*   and Latitude/Longitude system. File has been updated to fit our project
*   and use modern variables (e.g. Math.PI instead of direct value of pi).
*
*   Globals:
*     pi - Contains PI value
*     sm_a - Ellipsoid constant
*     sm_b - Ellipsoid constant
*     sm_EccSquared - Ellipsoid constant
*     UTMScaleFactor - Ellipsoid constant
*
*/
